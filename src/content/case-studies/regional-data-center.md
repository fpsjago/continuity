...
metrics:
  ...
  - { value: "312", label: "Channels certified" }
  - { value: "100%", label: "First-pass yield" }
---
The campus required a backbone it could hand to auditors. We delivered traced, documented fiber with headroom for the next generation of uplinks.
